...
|---|---|
| `index.html` | A ferramenta geradora — **~20.000 linhas** (10 abas: slideshow, captação de leads, agendamento TidyCal, checkout, bordas com efeito, contagem regressiva, link de cobrança, mini loja, efeitos de página, agendamento por pacote) mais o **painel consolidado** na faixa à direita, que monta a Tag Head e a Tag Body da página selecionada no preset geral. É a página servida pelo Pages. |
