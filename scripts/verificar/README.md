...
- **Nenhum arquivo daqui fala com a internet.** `pagina.mjs` aborta toda
  ...
  consequencia e que o `tidycal-altura.mjs` prova o bloco contra sinais
  **transcritos** de uma medicao, e nao contra o calendario do TidyCal ao vivo.
  A medicao ao vivo (rede liberada de proposito) foi feita uma vez, em
  03/09/2026, e o resultado esta transcrito no cabecalho daquele arquivo; refazer
  a medicao ao vivo e trabalho manual, e o dia em que o TidyCal trocar a
  biblioteca deles e o dia de refazer.
